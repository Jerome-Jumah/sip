...
class DialPadWidget extends StatefulWidget {
  ...
  const DialPadWidget(this._helper, {super.key});
...
class _MyDialPadWidget extends State<DialPadWidget> implements SipUaHelperListener {
  ...
  Future<Widget?> _handleCall(BuildContext context, [bool voiceOnly = false]) async {
    ...
    if (kIsWeb && !voiceOnly) {
      // Use simplified constraints for getDisplayMedia
      var displayConstraints = <String, dynamic>{
        'video': true,
      ...
      // Use modern constraint format for getUserMedia
      var mediaConstraints = <String, dynamic>{
        'audio': true,
        'video': voiceOnly
            ? false
